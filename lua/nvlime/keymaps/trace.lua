...
trace.add = function()
  ...
  km.buffer.normal(tm.normal.next_field, "<Cmd>lua require('nvlime.core.ui.trace_dialog').next_field(v:true)<CR>", "nvlime: Select the next interactable field/button")
  return km.buffer.normal(tm.normal.prev_field, "<Cmd>lua require('nvlime.core.ui.trace_dialog').next_field(v:false)<CR>", "nvlime: Select the previous interactable field/button")
end
return trace
