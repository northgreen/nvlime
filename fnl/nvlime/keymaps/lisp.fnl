...
(fn lisp.add []
  ...
  (km.buffer.normal lm.normal.disassemble.expr
                    "<Cmd>lua require('nvlime.core.plugin').disassemble_form(require('nvlime.ui_cursors').cur_expr())<CR>"
                    "nvlime: Disassemble the form under the cursor")
  (km.buffer.normal lm.normal.disassemble.symbol
                    "<Cmd>lua require('nvlime.core.plugin').disassemble_form(require('nvlime.ui_cursors').cur_symbol())<CR>"
                    "nvlime: Disassemble the form under the cursor")
  ...
  (km.buffer.normal lm.normal.repl.send_atom_expr
                    "<Cmd>lua require('nvlime.core.plugin').send_to_repl(require('nvlime.ui_cursors').cur_expr_or_atom())<CR>"
                    "nvlime: Send the expression/atom under the cursor to the REPL")
  (km.buffer.normal lm.normal.repl.send_atom
                    "<Cmd>lua require('nvlime.core.plugin').send_to_repl(require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Send the atom under the cursor to the REPL")
  (km.buffer.normal lm.normal.repl.send_expr
                    "<Cmd>lua require('nvlime.core.plugin').send_to_repl(require('nvlime.ui_cursors').cur_expr())<CR>"
                    "nvlime: Send the expression under the cursor to the REPL")
  (km.buffer.normal lm.normal.repl.send_toplevel_expr
                    "<Cmd>lua require('nvlime.core.plugin').send_to_repl(require('nvlime.ui_cursors').cur_top_expr())<CR>"
  ...
  (km.buffer.visual lm.visual.repl.send_selection
                    "<Cmd>lua require('nvlime.core.plugin').send_to_repl(require('nvlime.ui_cursors').cur_selection())<CR>"
                    "nvlime: Send the current selection to the REPL")

  (km.buffer.normal lm.normal.macro.expand
                    "<Cmd>lua require('nvlime.core.plugin').expand_macro(require('nvlime.ui_cursors').cur_expr(), 'expand')<CR>"
                    "nvlime: Expand the macro under the cursor")
  (km.buffer.normal lm.normal.macro.expand_once
                    "<Cmd>lua require('nvlime.core.plugin').expand_macro(require('nvlime.ui_cursors').cur_expr(), 'one')<CR>"
                    "nvlime: Expand the macro under the cursor once")
  (km.buffer.normal lm.normal.macro.expand_all
                    "<Cmd>lua require('nvlime.core.plugin').expand_macro(require('nvlime.ui_cursors').cur_expr(), 'all')<CR>"
                    "nvlime: Expand the macro under the cursor and all nested macros")

  (km.buffer.normal lm.normal.compile.expr
                    "<Cmd>lua require('nvlime.core.plugin').compile(require('nvlime.ui_cursors').cur_expr(true))<CR>"
                    "nvlime: Compile the expression under the cursor")
  (km.buffer.normal lm.normal.compile.toplevel_expr
                    "<Cmd>lua require('nvlime.core.plugin').compile(require('nvlime.ui_cursors').cur_top_expr(true))<CR>"
  ...
  (km.buffer.visual lm.visual.compile.selection
                    "<Cmd>lua require('nvlime.core.plugin').compile(require('nvlime.ui_cursors').cur_selection(true))<CR>"
                    "nvlime: Compile the current selection")

  (km.buffer.normal lm.normal.xref.function.callers
                    "<Cmd>lua require('nvlime.core.plugin').xref_symbol('CALLS', require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Show callers of the function under the cursor")
  (km.buffer.normal lm.normal.xref.function.callees
                    "<Cmd>lua require('nvlime.core.plugin').xref_symbol('CALLS-WHO', require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Show callees of the function under the cursor")
  (km.buffer.normal lm.normal.xref.symbol.references
                    "<Cmd>lua require('nvlime.core.plugin').xref_symbol('REFERENCES', require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Show references to the variable under the cursor")
  (km.buffer.normal lm.normal.xref.symbol.bindings
                    "<Cmd>lua require('nvlime.core.plugin').xref_symbol('BINDS', require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Show bindings for the variable under the cursor")
  (km.buffer.normal lm.normal.xref.symbol.definition
                    "<Cmd>lua require('nvlime.core.plugin').find_definition(require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Show the definition for the symbol under the cursor")
  (km.buffer.normal lm.normal.xref.symbol.set_locations
                    "<Cmd>lua require('nvlime.core.plugin').xref_symbol('SETS', require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Show locations where the variable under the cursor is set")
  (km.buffer.normal lm.normal.xref.macro.callers
                    "<Cmd>lua require('nvlime.core.plugin').xref_symbol('MACROEXPANDS', require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Show locations where the macro under the cursor is called")
  (km.buffer.normal lm.normal.xref.class.methods
                    "<Cmd>lua require('nvlime.core.plugin').xref_symbol('SPECIALIZES', require('nvlime.ui_cursors').cur_atom())<CR>"
  ...
  (km.buffer.normal lm.normal.describe.operator
                    "<Cmd>lua require('nvlime.core.plugin').describe_symbol(require('nvlime.ui_cursors').cur_operator())<CR>"
                    "nvlime: Describe the operator of the expression under the cursor")
  (km.buffer.normal lm.normal.describe.atom
                    "<Cmd>lua require('nvlime.core.plugin').describe_symbol(require('nvlime.ui_cursors').cur_atom())<CR>"
  ...
  (km.buffer.normal lm.normal.arglist.show
                    "<Cmd>lua require('nvlime.core.plugin').show_operator_arglist(require('nvlime.ui_cursors').cur_operator())<CR>"
                    "nvlime: Show the arglist for the expression under the cursor")
  (km.buffer.normal lm.normal.documentation.operator
                    "<Cmd>lua require('nvlime.core.plugin').documentation_symbol(require('nvlime.ui_cursors').cur_operator())<CR>"
  ...
  (km.buffer.normal lm.normal.documentation.atom
                    "<Cmd>lua require('nvlime.core.plugin').documentation_symbol(require('nvlime.ui_cursors').cur_atom())<CR>"
  ...
  (km.buffer.normal lm.normal.inspect.symbol
                    "<Cmd>lua require('nvlime.core.plugin').inspect(require('nvlime.ui_cursors').cur_symbol())<CR>"
  ...
  (km.buffer.visual lm.visual.inspect.selection
                    "<Cmd>lua require('nvlime.core.plugin').inspect(require('nvlime.ui_cursors').cur_selection())<CR>"
  ...
  (km.buffer.normal lm.normal.trace.toggle
                    "<Cmd>lua require('nvlime.core.plugin').dialog_toggle_trace(require('nvlime.ui_cursors').cur_atom())<CR>"
  ...
  (km.buffer.normal lm.normal.undefine.function
                    "<Cmd>lua require('nvlime.core.plugin').undefine_function(require('nvlime.ui_cursors').cur_atom())<CR>"
                    "nvlime: Undefine the function under the cursor")
  (km.buffer.normal lm.normal.undefine.symbol
                    "<Cmd>lua require('nvlime.core.plugin').unintern_symbol(require('nvlime.ui_cursors').cur_atom())<CR>"
